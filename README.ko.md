...
**레거시: 오디오 핑거프린트 에코 감지기 (제거됨)**

Pearson 상관계수 기반 청크별 에코 감지기가 초기 접근 방식이었으나, PSTN 오디오에서 에코가 왜곡되고 시간 편이되어 신뢰할 수 없음이 확인되어 코드베이스에서 제거되었습니다. Silence Injection 방식이 더 단순하고 안정적입니다.
