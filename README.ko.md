...
[![Tests](https://img.shields.io/badge/Tests-74_passing-22C55E?style=for-the-badge&logo=pytest&logoColor=white)](#테스트)
...
| 모드 | 입력 | 출력 | 대상 |
|------|------|------|------|
| **Voice → Voice** | 모국어 음성 | 번역된 음성 + 자막 | 일반 사용자 |
| **Text → Voice** | 텍스트 입력 | AI가 대신 말해줌 | 언어 장애, 콜포비아 |
| **Voice → Text** | 음성 | 실시간 자막 | 청각 장애 |
| **Agent Mode** | 정보만 제공 | AI가 전화 전체를 자율 진행 | 모든 사용자 |
