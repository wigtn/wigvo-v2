...
\usepackage{xcolor}
\usepackage{amssymb}
% NOTE: fontspec + AppleMyungjo 제거 — Linux/Overleaf 빌드 깨짐 원인
% 한국어가 필요하면 CJKutf8 패키지로 대체할 것
...
This work was conducted independently by the WIGTN crew at SoundMind Inc. We thank the anonymous reviewers for their feedback. WIGVO uses OpenAI's Realtime API~\citep{openai_realtime_api_2024} and Twilio Media Streams~\citep{twilio_media_streams_2024}. The relay server is implemented in Python with FastAPI.
